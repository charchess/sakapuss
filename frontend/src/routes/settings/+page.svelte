...
<div class="settings-page">
  ...
  <section class="settings-section">
    ...
    <a href="/settings/resources" class="config-link">
      <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-cat-litter)" stroke-width="2" stroke-linecap="round"><rect x="3" y="3" width="18" height="18" rx="3"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>
      <span>Ressources du foyer</span>
      <span class="arrow">›</span>
    </a>
    <a href="/settings/vet-sharing" class="config-link">
      <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" stroke-width="2" stroke-linecap="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.95 9.18 19.79 19.79 0 01.88 .5 2 2 0 012.86.5h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L7.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></svg>
      <span>Partage vétérinaire</span>
      <span class="arrow">›</span>
    </a>
  </section>

...
test.describe('Weight Chart Visualization (ATDD - Story 2.4)', () => {
  ...
  test('[P0] should display weight chart when pet has weight data', async ({ page, seedPet, request }) => {
  ...
  test('[P0] should show weight values on the chart', async ({ page, seedPet, request }) => {
  ...
  test('[P1] should show insufficient data message with fewer than 2 weight events', async ({ page, seedPet, request }) => {
  ...
  test('[P1] should not show weight chart when pet has no weight events', async ({ page, seedPet, request }) => {

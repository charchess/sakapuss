...
class Resource(Base):
    ...
    color: Mapped[str | None] = mapped_column(String(20), nullable=True)  # hex color e.g. #6C5CE7
    tracking_mode: Mapped[str | None] = mapped_column(String(20), nullable=True)  # weight, volume, none
